      ...
      ...(diagnostic.family === 'github'
        ? {
            github: {
              ...
              short_summary: '',
	              newest_content: '',
	              priority_level: diagnostic.github_priority_level || 'P3_LOW',
	              priority: {
	                priorityLevel: diagnostic.github_priority_level || 'P3_LOW',
	                eventCode: diagnostic.github_event_type || 'unknown',
	                friendlyText: diagnostic.github_friendly_text || '',
	                safeSummary: diagnostic.github_safe_summary || '',
	                reasons: [],
	              },
	              safe_summary: diagnostic.github_safe_summary || '',
