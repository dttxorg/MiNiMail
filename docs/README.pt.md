...
Este repositório de engenharia mantém o código-fonte, a documentação de lançamento e uma breve visão geral de design. Veja [design.md](design.md) para mais contexto.
